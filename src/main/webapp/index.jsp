...
<div id="tb" style="padding:5px;height:auto">
    <div style="margin-bottom:5px">
       ...
       <%-- <c:if test="${Account.jurisdiction== 'manage'}">--%>
        <c:if test="${Account.dept== '就业部'}">
            <a href="#" data-method="infoPage" class="easyui-linkbutton" iconCls="icon-remove" plain="true">学生信息表管理</a>
        </c:if>
        <c:if test="${Account.jurisdiction== 'manage'}">
    ...
    <form id="editForm" action="" method="post">
        ...
        <table>
            ...
            <tr>
                <td>班级:</td>
                <%--<td><input name="username" class="f1 easyui-validatebox" validType="checkName" data-options="required:true"></input></td>--%>
                <td><input name="classes" class="f1 easyui-validatebox"  data-options="required:true"></input></td>
            </tr>
            <tr data-save="true">
                <td>毕业学校:</td>
